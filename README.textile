...
* works *only in Google Chrome, Mozilla Firefox and the last version of Internet Explorer*
...
* download one of:
** latest release zip: https://github.com/peclik/clipboard_image_paste/archive/v1.8.zip
...
* *works only in Google Chrome, Mozilla Firefox and the last version of Internet Explorer*
* tested on Chrome 24, 15, 13, Firefox 18, 16, 5 and Internet Explorer 11, 8
