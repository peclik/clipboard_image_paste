...
* clipboard_image_paste combines number of both regular files and pasted images
  for maximum number of attachment checks, while Redmine ignores
  the number pasted images
